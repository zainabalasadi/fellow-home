            ...
            <overline>
                <BrowserRouter>
                    <Grid direction="row" container justify="space-between" alignItems="center">
                        ...
                        <TextInput.InputText 
                            onEnter={(e) => searchMap(e)} 
                            classNames={{width: "25%", height: "10%", fontsize:"8px"}} 
                        ...
                        <Button disableRipple href={'../saved'}>
                            Saved
                        </Button>
                        <Button disableRipple href={'../messages'}>
                            Messages
                        </Button>
                        <Button disableRipple href={'../help'}>
                            Help
                        </Button>
